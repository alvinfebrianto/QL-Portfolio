...
<template>
    <nav class="bg-light-primary border-gray-200 dark:bg-dark-primary">
        ...
        >
            <a
                href="https://github.com/alvinfebrianto"
                class="flex items-center space-x-3 rtl:space-x-reverse"
            >
                <img src="img/avatar.png" class="h-8" alt="Logo" />
                <span
                    class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"
                    >Alvin Febrianto</span
                >
            </a>
            <button
            ...
            >
                ...
                >
                    <li>
                        <a
                            href="#"
                            class="block py-2 px-3 text-white bg-light-tail-500 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500"
                            aria-current="page"
                            >Home</a
                        >
                    </li>
